...
<P>For More Details Refer to <A href="https://github.com/peipeilihfut/Term-Similarity-based-on-Semantic-Network-Probase-/blob/master/SimCompleteResults.pdf" target=_new onClick="stc(this, 26)">Complete Results on Three Data Sets</A>.</P></div>
        <div style="clear:both;"></div>
